...
export const GetInitialSlideShowDataSuccess = createAction(ESlideShowActions.GET_INITIAL_SLIDESHOW_DATA_SUCCESS, props<{ payload: IPicture[] }>());
export const AddSlideShowImage = createAction(ESlideShowActions.ADD_SLIDESHOW_IMAGE, props<{ payload: IPicture[] }>())
export const AddSlideShowImageSuccess = createAction(ESlideShowActions.ADD_SLIDESHOW_IMAGE_SUCCESS, props<{ payload: IPicture[] }>())
